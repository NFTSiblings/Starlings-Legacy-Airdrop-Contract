...
contract CenterFacet is ERC721 {
    ...
    function returnHash(uint256 tokenId) external view returns (bytes memory) {
        // return abi.encodePacked(msg.sender, tokenId).toEthSignedMessageHash();
        return abi.encodePacked(msg.sender, tokenId);
    }
